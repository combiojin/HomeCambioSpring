					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" class="form-control"
								...
								placeholder="Id" name="member_id" readonly="readonly">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" class="form-control" id="member_name"
								placeholder="Name" name="member_name" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<input type="text" class="form-control" id="member_birth"
								placeholder="ex)19000000" name="member_birth" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
